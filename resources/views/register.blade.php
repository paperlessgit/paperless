                    ...
                    <div class="col-md-8 col-lg-6 col-xl-5">
                        <div class="card overflow-hidden">
                            ...
                            <div class="card-body pt-0"> 
                                ...
                                <div class="p-2">
                                    <form class="form-horizontal" action="{{route('register.data')}}" method="post">
                                        @csrf
                                        ...
                                        <div class="mt-4 text-center">
                                            ...
                                            <ul class="list-inline">
                                                <li class="list-inline-item">
                                                    <a href="https://www.facebook.com/" class="social-list-item bg-primary text-white border-primary">
